const serverID = '1404565410694697144'; // ID serveru
const channelID = '1405142685546975282'; //POZVANKY
    ...
    const html = await Promise.all(games.map(async g => {
        ...
        return `
          <div class="hra">
            ...
            <div class="msglink"><i class="fa-solid fa-arrow-up-right-from-square"></i> <a href="https://discord.com/channels/${serverID}/${channelID}/${g.id}">Otevřít v Discordu</a></div>
          </div>
    `}));
